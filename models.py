...
class Employee(db.Model):
    ...
    outgoing_edges = db.relationship("Relationship", foreign_keys="Relationship.source_id", backref="source", lazy="dynamic", cascade="all, delete-orphan")
    incoming_edges = db.relationship("Relationship", foreign_keys="Relationship.target_id", backref="target", lazy="dynamic")
